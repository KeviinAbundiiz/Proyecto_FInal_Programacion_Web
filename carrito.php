...
<center>
    ...
    <a href="index.php"> <input id="btn-comprar" type="button"  value="Regresar"></a>

    <a href="insertar_compra.php"> <input id="btn-comprar" type="button" value="Comprar"></a>
        ...
        $(document).ready(function(){
            ...
            $(".btnEliminar").click(function(){
                ...
                $.ajax({
                    ...
                    // a la página eliminarCarrito.php, solo utizamos, en caso de ser necesario, 
                    ...
                    //al recibir la confirmación de eliminacion, borramos el elemento de forma visual
