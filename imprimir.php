...
$pdf->Cell(40,10,'Cantidad',1,0,'L');

$pdf->Cell(40,10,'Precio',1,0,'L');

$pdf->Cell(62.5,10,'Subtotal',1,1,'L');
...
foreach($resultado as $dato){
    ...
    $pdf->Cell(40,10,$dato['cantidad'],1,0,'L');

    $pdf->Cell(40,10,'$'.$dato['precio'],1,0,'L');

    $pdf->Cell(62.5,10,'$'.$dato['subtotal'],1,1,'L');
...
$pdf->Cell(62.5,10,'Subtotal Equipos: $'.$total,1,1,'L');
...
$pdf->Cell(62.5,10,'Iva: $'.$iva,1,1,'L');
...
$pdf->Cell(62.5,10,'Total: $'.$resultado[0]['total'],1,0,'L');
